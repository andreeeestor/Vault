    ...
    <div className="flex flex-col gap-5 w-full max-w-[340px] mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <Button
          type="submit"
          disabled={loading}
          className="h-[52px] rounded-full bg-(--gradient-brand) text-white font-semibold text-[15px] shadow-[0_4px_14px_rgba(124,58,237,0.35)] hover:shadow-[0_6px_20px_rgba(124,58,237,0.45)] hover:-translate-y-0.5 active:translate-y-0 transition-all"
        >
      ...
      <p className="text-center text-xs text-[var(--foreground-subtle)] mt-2">
        Já tem uma conta?{" "}
        <Link
          href="/login"
